...
.order-1 { order: 1; background-color: red ; }
.order-2 { order: 2; }
.order-3 { order: 3; }
...
<div class="modal fade" id="addEmployeeModal" tabindex="-1" aria-labelledby="exampleModalLabel"
  ...
  <div class="modal-dialog modal-dialog-centered">
    <div class="modal-content">
      ...
      <form action="{{ url('/store') }}" method="POST" id="add_employee_form" enctype="multipart/form-data">
        @csrf
        ...
        <div class="card shadow">
          <div class="card-header bg- d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-light" data-bs-toggle="modal" data-bs-target="#addEmployeeModal"><i
                class="bi-plus-circle me-2"></i>Add user</button>
          </div>
